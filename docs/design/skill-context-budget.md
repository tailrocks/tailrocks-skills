...
else is the router's job. The current 74 descriptions total 19,075 characters;
15,610 count against the per-skill caps. The other 3,465 are the 3,402 guard
