      ...
      <main className="mx-auto flex w-full max-w-4xl flex-1 flex-col gap-12 px-4 py-16">
        <section className="flex flex-col gap-4">
          ...
          <p className="text-fd-muted-foreground text-lg">
            Reusable engineering skills for coding agents — strict Rust and Axum, strict TypeScript and
            TanStack, native macOS with Liquid Glass, code-health ratchets, correctness-first remediation, and
            a roadmap delivery pipeline.
          </p>
