...
| macOS (Swift, Liquid Glass) | `tailrocks-macos-design` | `tailrocks-macos-design` — on the running prototype | `tailrocks-macos-visual-qa` |
...
against the blessed reference. On macOS the Liquid Glass material authority
lives inside `tailrocks-macos-design` — it is the rulebook the design and
prototype stages consult, not a stage of its own.
