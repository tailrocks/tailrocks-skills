...
| Web (TanStack, shadcn/ui)   | Guarded `/design/...` routes in the real app, blessed live in the browser  | `tailrocks-web-design`   | `tailrocks-web-design`                                 | `tailrocks-web-visual-qa`                | `tailrocks-web-design-audit`        |
