...
Thirteen skills appear. Seven are the delivery pipeline; the rest are the
stack skills it hands work to.
...
## 6. Prove it runs — `tailrocks-macos-prototype`
...
<Invoke skill="tailrocks-macos-prototype" args="log-explorer: build the prototype from the approved design and walk every scenario with me" />
...
|---|---|---|
| — | Not a slice: the signed-off prototype and its `Regions.md`, standing before READY | `tailrocks-macos-prototype` |
...
| 004 | Timeline and results surface: the prototype's view layer over real snapshots, with its Liquid Glass chrome | `tailrocks-liquid-glass`, `tailrocks-swift-best-practices` |
...
## 10. Reconcile — `tailrocks-reconcile`
