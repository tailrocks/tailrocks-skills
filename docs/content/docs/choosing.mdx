...
flowchart LR
  ...
  review --> design
  design --> swift["swift-best-practices"]
...
| macOS    | Swift, SwiftUI, Liquid Glass     | [`tailrocks-macos-design`](/docs/skills/tailrocks-macos-design) | same — on the running prototype | [`tailrocks-macos-visual-qa`](/docs/skills/tailrocks-macos-visual-qa) | [`tailrocks-macos-design-review`](/docs/skills/tailrocks-macos-design-review) |
