...
- [ ] `roadmap/goal-live-status/plan/README.md` row 002 changes from IN
      PROGRESS to DONE in the same commit; this Status-column edit is the
      permitted protocol write.
