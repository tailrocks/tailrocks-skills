...
description: >-
  Use only when the user explicitly requests this skill. Inspect one skill or the portfolio and report behavioral, structural, efficiency, portability, security, evaluation, and overlap defects. Never edits audited skills or wiring; writes only skill-audits/ reports.
...
2. **Judge against the doctrine.** Read
   ...
   boundaries, client portability, eval freshness, and split/merge topology.
