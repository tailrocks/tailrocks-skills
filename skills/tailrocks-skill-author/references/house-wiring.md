...
| Root `AGENTS.md` | Add the skill's section by hand; record lineage when the skill descends from external work — knowledge is extracted into this tree's own references, never linked as a dependency. |
