...
test("selection-critical route fields match the complete ordered matrix", () => {
  expect(
    ...
    "branch-deep|branch [category] --deep|branch [category]|branch|<validated category aspect>|-|-|-",
    "branch|branch [category]|branch [category]|branch|<validated category aspect>|-|-|-",
