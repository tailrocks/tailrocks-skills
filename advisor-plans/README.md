...
| [008](008-family-ownership-and-handoffs.md) | 6th | One owner per rule; working handoffs | P1 | M–L | 004, 005, 006, 007 | BLOCKED — maintainer-choice STOP resolved with a named SwiftUI-host fallback and Swift case 4 passes 2/2; full family rerun remains incomplete because liquid-glass case 2 exhausted two 180-second Claude attempts |
...
| [012](012-repo-ci-install-hardening.md) | 6th | CI topology, v0.12.0 pins, validator gaps, age gate | P2 | M | — | BLOCKED — strict `validate` + `templates-macos` protection is live via github-terraform PR #3; only the required post-merge `v0.12.0` tag remains blocked while PR #11 stays unmerged |
| [013](013-dogfood-example-and-intake.md) | 6th | Ship w6 dogfood example; land its learnings | P2 | S–M | 006, 007 | BLOCKED — deterministic gates, design cases 1–6, and liquid case 1 pass 2/2; liquid case 2 exhausted two bounded 180-second Claude attempts, so the complete affected-suite rerun is not green |
