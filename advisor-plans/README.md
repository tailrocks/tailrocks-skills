...
| [007](007-visual-qa-harness-hardening.md) | 6th | Visual-qa restore safety + capture/drive harness | P1 | M–L | — (004 for rerun) | BLOCKED — branch-head Done-criteria recheck: `TMPDIR=/var/folders/zz capture.sh /var/folders/zz/Fake.app …` exits 1 (`error: permissionDenied`), required exit 2 |
