...
| [008](008-family-ownership-and-handoffs.md) | 6th | One owner per rule; working handoffs | P1 | M–L | 004, 005, 006, 007 | DONE — SwiftUI-first ownership landed; all 37 macOS-family cases pass 2/2 with bounded 600-second Claude attempts |
...
| [012](012-repo-ci-install-hardening.md) | 6th | CI topology, v0.12.0 pins, validator gaps, age gate | P2 | M | — | DONE — github-terraform PR #3 merged; strict `validate` + `templates-macos` protection is live and maintainer-authorized `v0.12.0` targets this PR's final merge commit |
| [013](013-dogfood-example-and-intake.md) | 6th | Ship w6 dogfood example; land its learnings | P2 | S–M | 006, 007 | DONE — deterministic dogfood gates pass; all 6 design and 7 liquid-glass cases pass 2/2 on branch head |
