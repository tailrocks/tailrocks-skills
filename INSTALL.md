...
`claude plugin marketplace add tailrocks/tailrocks-skills@v0.15.0`.
...
Use the latest release tag in place of `v0.15.0` when upgrading.
...
Pin with a release URL (`.../releases/tag/v0.15.0`) or `/tree/<ref>`.
