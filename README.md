...
| [`tailrocks-plan`](skills/tailrocks-plan/README.md) | Convert a READY roadmap item into roadmap/<slug>/plan/ and goal/: coverage ledger, research-gap manifest, an OpenSpec-grammar spec, one zero-context plan per work item, and the goal handoff. | Manual only |
